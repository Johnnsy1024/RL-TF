...
arg_parser.add_argument("--memory_size", type=int, help="replay buffer size", default=1000)
...
arg_parser.add_argument("--target_update_freq", type=int, help="target update frequency", default=10)
