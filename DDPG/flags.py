...
arg_parser.add_argument("--hidden_dim", type=int, help="hidden_dim", default=128)
arg_parser.add_argument("--actor_lr", type=float, help="actor_lr", default=1e-3)
arg_parser.add_argument("--critic_lr", type=float, help="critic_lr", default=1e-3)
arg_parser.add_argument("--sigma", type=float, help="normal noise std", default=0.1)
