...
arg_parser.add_argument(
    "--actor_lr", type=float, help="actor learning rate", default=1e-3
)
arg_parser.add_argument(
    "--critic_lr", type=float, help="critic learning rate", default=1e-2
)
arg_parser.add_argument(
    "--num_episodes", type=int, help="number of episodes", default=3000
)
